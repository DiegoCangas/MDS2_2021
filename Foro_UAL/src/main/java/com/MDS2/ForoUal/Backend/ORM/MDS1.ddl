...
CREATE TABLE `Moderador` (`IdMod` bigint(20), `UsuarioID` bigint(20) NOT NULL, PRIMARY KEY (`UsuarioID`)) ENGINE=InnoDB;
...
ALTER TABLE `Moderador` ADD CONSTRAINT `FKModerador273168` FOREIGN KEY (`UsuarioID`) REFERENCES `Usuario` (`ID`);
