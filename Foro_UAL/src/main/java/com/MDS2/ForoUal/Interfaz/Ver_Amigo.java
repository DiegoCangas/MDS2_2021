...
public class Ver_Amigo extends Ver_Amigo_Ventana{
	...
	public void Anadir_Amigo() {
		foroUI.db.Insertar_Amigo(usuario.getNombreUsuario());
		foroUI.db.Crear_Notificacion((int)usuario.getORMID(), foroUI.user.getNombreUsuario() + " te ha añadido como amigo");
	}

	public void Eliminar_Amigo() {
		foroUI.db.Eliminar_Amigo(usuario.getNombreUsuario());
		foroUI.db.Crear_Notificacion((int)usuario.getORMID(), foroUI.user.getNombreUsuario() + " te ha borrado como amigo");
	}
}